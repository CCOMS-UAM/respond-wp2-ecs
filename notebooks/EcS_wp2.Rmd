...
```{r}
rm(anxiety, brs, brsw2, covidcc, depression, economic, flourishing, g1, g2, g3, g4, livingalone, loneliness_ss_si, lte, materialdep, negposaf, occ_unique, personality, qol, socialsupw2, tobacco, prueba)
```
...
```{r}
nuts_provinces <- read_excel("./dat/NUTS2021.xlsx", 
                       sheet = "NUTS 1 to 3")
```

```{r}
nuts_urbanrural <- read_excel("./dat/NUTS2021.xlsx",
                              sheet = "Urban - Rural")
```

```{r}
nuts_urbanruralremoteness <- read_excel("./dat/NUTS2021.xlsx",
