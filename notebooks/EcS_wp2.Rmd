...
data_2019_test <- data_2019_test %>%
  mutate(
    ...
    across(q0410g_total_r:q0410k_other_r, ~na_if(., 888)),
    across(q0410g_total_r:q0410k_other_r, ~na_if(., 999)),
    across(q0410g_total_r:q0410k_other_r, ~coalesce(., 0)),
    hh_income_r_NA = q0410g_total_r + q0410i_ss_r + q0410j_government_r + q0410k_other_r
  )
#FIXME!!!
```
