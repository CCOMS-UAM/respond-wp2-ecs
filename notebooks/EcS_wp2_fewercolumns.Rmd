...
#SE HAN ELIMINADO LA ADICIÓN DE VARIABLES EXTRA 
# Step 6. Hashed IDs
...
# Step 10. Save .RDS
```{r}
saveRDS(df, "./dat/sinvariablesextra.rds")
test <- readRDS("./dat/sinvariablesextra.rds")
```
```{r}
#Wave 1
w2019 <- df |> filter(wave == 1)
saveRDS(w2019, "./dat/sinvariablesextraw1.rds")
wCOVID <- df |> filter(wave == 2)
saveRDS(wCOVID, "./dat/sinvariablesextraw2.rds")
```