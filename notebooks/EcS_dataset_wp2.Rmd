...
```{r}
data_2019_test %>% 
  freq_table(q0410g_total_r) %>% 
  print(n = 50) # 371 + 819 = 1190 NON_RESPONSE
```

```{r}
data_2019_test  %>% 
  freq_table(q0410i_ss_r) %>% 
  print(n = 50) #267 + 824 = 1091 NON_RESPONSE
```

```{r}
data_2019_test  %>% 
  freq_table(q0410j_government_r) %>% 
  print(n = 50) #230 + 766 = 966 NON_RESPONSE
```

```{r}
data_2019_test  %>% 
  freq_table(q0410k_other_r) %>% 
  print(n = 50) #291 + 710 = 1001 NON_RESPONSE
```
