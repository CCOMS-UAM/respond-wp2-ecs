...
```{r}
data_2019 <- read_dta(BASELINE_FILEPATH)
...
Our categories are: 1 = male; 2 = female (and the question is not about the
...
are from Spain, we can do it from scratch.
...
## A REVISAR 4 & 5.AGE (q1010_birth_date &/OR q1011_age)
...
data_2019_test <-
  ...
  mutate(employment_ty = case_when(
       ...
       q1510e_workday == 999 ~ REFUSED_ANSWER,
