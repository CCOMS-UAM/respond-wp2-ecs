...
-   [X] Darle una segunda vuelta a esto, porque igual hay gente que tiene hijos
    ...
    -   [ ] Darle otra vuelta a la no coincidencia de los NAs. (--> Link a children-issue.Rmd)
...
- [X] TODO: Añadir una fila por cada ítem individual. 
- [X] duda: ¿hay que cambiar el nombre de los items en la BBDD final? (formato long)
