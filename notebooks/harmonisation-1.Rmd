...
data_2019_test <- data_2019_test %>% 
  mutate(hhquintile = case_when(
                          hh_income_r_NA <= income[2,2] ~ 1,
                          hh_income_r_NA > income[2,2] & hh_income_r_NA <= income[2,3] ~ 2,
                          hh_income_r_NA > income[2,3] & hh_income_r_NA <= income[2,4] ~ 3,
                          hh_income_r_NA > income[2,4] & hh_income_r_NA <= income[2,5] ~ 4,
                          hh_income_r_NA > income[2,5] ~ 5
