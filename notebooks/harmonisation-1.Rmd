...
<!-- -[ ] Revisar los valores perdidos de ambas categorías. La variable de texto libre en teoría no tiene NAs, pero cuando combinas ambas dos, sí. ¿Qué está                 pasando?-->
...
data_2019_test <-
  ...
  mutate(profession = case_when(
                      q1510_catoccu ==  2  ~  2 , #professionals --> education & research
                      q1510_catoccu ==  7  ~  3 , #craft workers --> arts, entertainment, sports & media
                      ...
                      q1510_catoccu ==  3  ~  8 , # technicians --> finance & economy
                      q1510_catoccu ==  9  ~  10 , #elementary occupations --> sales and services
                      q1510_catoccu ==  6  ~  11 , #skilled agricultural workers --> transport (goods and people)
                      q1510_catoccu ==  4  ~  12 , #clerks --> installation, maintenance, cleaning and reparis
                      q1510_catoccu ==  8  ~  14, #plant operators --> other,
...
-   [ ] As the variables are not exactly the same, there's a need to clarify and
    agree on a combination proposal.
...
data_2019_test <-
  ...
  mutate(contract = case_when(
        ...
        q1510b_contract_earner == 2 ~ 3, #indefinite period (not officer) --> self-employed
        q1510b_contract_earner == 3  ~ 2, #temporal or contract of works and services --> temporary
        q1510b_contract_earner == 4 ~ 4, #verbal or without contract
