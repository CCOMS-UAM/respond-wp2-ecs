...
mat_dep2019 <- read_dta('~/../UAM/Marta Miret Garcia - Documentacion Edad con Salud/Edad con salud - Ola 3/Outcomes/Cohorte 2019/Outcome datasets/Outcome_materialdeprivation.dta')
```
...
The data we will use are from Wave 1 (2019 cohort) and the COVID sub-study. We have two main sources of information:
...
-   **Raw databases**. Found at:
    ...
    -   **COVID SUBSTUDY**: `~/UAM/Marta Miret Garcia - Bases de datos maestras Edad con Salud/Subestudio_COVID`.

-   **Questionnaires**. Found at

    -   **2019 COHORT**: `~/UAM/Marta Miret Garcia - Documentacion Edad con Salud/Edad con Salud - Ola 3/Cuestionario`

    -   **COVID SUBSTUDY**: `~/UAM/Marta Miret Garcia - Documentacion Edad con Salud/Edad con salud - Subestudio COVID/Cuestionario`
...
As an adaptation from the WHO-DAS II questionnaire, which asks for a general evaluation of the last 30 days, information about the amount of physical pain (**q2007_pains**) and pain-associated difficulty (**q2009_difficulty**) is recollected. Both variables are ordinal and have the following answer format:
