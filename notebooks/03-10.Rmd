...
#Filtrar por el grupo 2, crear un dataset sólo con esa variable filtrada por la del grupo 2. 
#Revisar UTF-8
...
#Una variable tipo factor recodificada anterior pero con las etiquetas correctas. 
#Crear otra variable a partir de esta con integer, filtrar convirtiendo en missing con valores no válidos (NAs)
#Operar. 
#na_if()
#Crear un objeto con constantes en MAYÚSCULAS: NON-RESPONSE = -92. 
```
...
freq_table(data_2019_test, children_hh) #5 personas sólo tienen niños en su casa? No coincide con el resto de variables
